...
def _transform_lc_to_csv(lightcurve: LightcurveResult, handle: io.StringIO) -> str:
    """
...
def _transform_lc_to_hdf5(lightcurve: LightcurveResult, handle: io.BytesIO) -> bytes:
    """
